  ...
  <div class="submission-question card">
        ...
        <div class="submission-answer">
          ...
          <div class="list-group">
            <input type="radio" name=${question.id} id="o${question.option_a}q${question.id}" value=${question.option_a}>
            ...
            <input type="radio" name=${question.id} id="o${question.option_b}q${question.id}" value=${question.option_b}>
            ...
            <input type="radio" name=${question.id} id="o${question.option_c}q${question.id}" value="${question.option_c}">
            ...
            <input type="radio" name=${question.id} id="o${question.option_d}q${question.id}" value="${question.option_d}">
